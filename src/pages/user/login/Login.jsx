        ...
        <div className='w-1/2 h-full  bg-[#f5f5f5] flex flex-col  justify-between p-20 items-center  box '>
         ...
         <div className='w-full flex flex-col max-w-[500px]  '>
          ...
          <div className=' flex flex-col ml-12 mr-12 my-4'>
            <button className=' w-full my-2 h-[12px] text-white bg-[#060606] rounded-md p-4 text-center flex items-center font-semibold justify-center cursor-pointer'>Log in</button>
            <button className=' w-full my-2 h-[12px] text-[#060606] bg-white border-black border-2 rounded-md p-4 my-2 font-semibold text-center flex items-center justify-center cursor-pointer '>Register</button>
          </div>
          ...
          <div className='w-full flex- items-center justify-center '>
            <p className='text-sm font-normal text-[#060606] text-center'>Don't have a accont? <span className='left_navlinks font-semibold underline underline-offset-2 cursor-pointer '><NavLink
